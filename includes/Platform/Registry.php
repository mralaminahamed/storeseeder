...
use StoreSeeder\Platforms\Fluent_Cart\Platform as Fluent_Cart;
...
final class Registry {
	 ...
	 * @since 1.1.0
	 *
	 * @return array<string, Platform> Keyed by platform id.
	 */
	public function all(): array {
		 ...
		 * StoreSeeder\Platform\Platform — extending
		 * StoreSeeder\Abstracts\Platform_Driver is the shortest route — and every
	 ...
	 *
	 * @return Platform|null Null when no driver claims that id.
	 */
	...
	public function active(): array {
		return array_filter(
			$this->all(),
			static function ( Platform $platform ): bool {
	...
	public function labels(): array {
		return array_values(
			array_map(
				static function ( Platform $platform ): string {

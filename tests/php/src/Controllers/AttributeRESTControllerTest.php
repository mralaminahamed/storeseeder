...
class AttributeRESTControllerTest extends StoreSeederUnitTestCase {
	...
	public function test_route_registration(): void {
		...
		$route  = '/' . $this->namespace . '/attributes/generate';
	...
	public function test_generate_requires_authentication(): void {
		...
		$request = $this->get_wp_rest_request( 'POST', '/attributes/generate' );
	...
	public function test_generate_valid_request(): void {
		...
		if ( 200 === $response->get_status() ) {
			...
			$this->assertIsArray( $data['attribute'] );
		}
	}
}

 ...
 *
 * @covers \StoreSeeder\Controllers\Resources\Shipping_Plan
 */
class ShippingPlanRESTControllerTest extends StoreSeederUnitTestCase {
	 ...
	 * @var Shipping_Plan
	 */
	private Shipping_Plan $controller;
	...
	public function test_route_registration(): void {
		...
		$route  = '/' . $this->namespace . '/shipping-plans/generate';
	...
	public function test_generate_valid_request(): void {
		...
		if ( 200 === $response->get_status() ) {
			...
			$this->assertArrayHasKey( 'shipping_plan', $data );
			$this->assertIsArray( $data['shipping_plan'] );
		}
	}
}

...
/**
 * Tests for the Customer REST controller.
 *
 * @covers \FluentCartFakerPress\Controllers\Customer
 */
class CustomerRESTControllerTest extends FluentCartFakerPressUnitTestCase {
	...
	public function test_controller_instantiation(): void {
		$this->assertInstanceOf( Customer::class, $this->controller );
	}
	...
	public function test_route_registration(): void {
		...
		$route  = '/' . $this->namespace . '/customers/generate';

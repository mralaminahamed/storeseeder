 ...
 *
 * @covers \StoreSeeder\Controllers\Resources\Label
 */
class LabelRESTControllerTest extends StoreSeederUnitTestCase {
	...
	public function test_controller_instantiation(): void {
		$this->assertInstanceOf( Label::class, $this->controller );
	}
	...
	public function test_route_registration(): void {
		...
		$route  = '/' . $this->namespace . '/labels/generate';
	...
	public function test_generate_requires_authentication(): void {
		...
		$request = $this->get_wp_rest_request( 'POST', '/labels/generate' );

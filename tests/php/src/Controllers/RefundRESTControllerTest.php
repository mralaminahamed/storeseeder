 ...
 *
 * @covers \StoreSeeder\Controllers\Resources\Refund
 */
class RefundRESTControllerTest extends StoreSeederUnitTestCase {
	...
	public function test_route_registration(): void {
		...
		$route  = '/' . $this->namespace . '/refunds/generate';
	...
	public function test_generate_requires_authentication(): void {
		...
		$request = $this->get_wp_rest_request( 'POST', '/refunds/generate' );
	...
	public function test_generate_valid_request(): void {
		...
		if ( 200 === $response->get_status() ) {
			...
			$this->assertArrayHasKey( 'refund', $data );
			$this->assertIsArray( $data['refund'] );
		}
	}
}

 ...
 *
 * @covers \StoreSeeder\Controllers\Resources\Product_Download
 */
class ProductDownloadRESTControllerTest extends StoreSeederUnitTestCase {
	 ...
	 *
	 * @var Product_Download
	 */
	private Product_Download $controller;
	...
	public function setUp(): void {
		parent::setUp();
		$this->controller = new Product_Download();
	...
	public function test_controller_instantiation(): void {
		$this->assertInstanceOf( Product_Download::class, $this->controller );
	}
	...
	public function test_route_registration(): void {
		...
		$route  = '/' . $this->namespace . '/product_downloads/generate';
	...
	public function test_generate_requires_authentication(): void {
		...
		$request = $this->get_wp_rest_request( 'POST', '/product_downloads/generate' );
	...
	public function test_generate_valid_request(): void {
		...
		if ( 200 === $response->get_status() ) {
			...
			$this->assertArrayHasKey( 'product_download', $data );
			$this->assertIsArray( $data['product_download'] );
		}
	}
}

...
class CartSessionRESTControllerTest extends StoreSeederUnitTestCase {
	 ...
	 * @var Cart_Session
	 */
	private Cart_Session $controller;
	...
	public function test_route_registration(): void {
		...
		$route  = '/' . $this->namespace . '/cart-sessions/generate';
	...
	public function test_generate_valid_request(): void {
		...
		if ( 200 === $response->get_status() ) {
			...
			$this->assertArrayHasKey( 'cart_session', $data );
			$this->assertIsArray( $data['cart_session'] );
		}
	}
}

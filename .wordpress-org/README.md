...
three share one palette: `tests/assets/brand.ts`.
...
**Banners** — composed from markup in `tests/assets/wporg-banners.spec.ts`. One
...
`tests/assets/wporg-shots.spec.ts`. This one does need a WordPress install with
